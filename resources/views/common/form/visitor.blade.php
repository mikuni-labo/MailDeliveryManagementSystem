...
<div class="form-group{{ $errors->has('organization') ? ' has-error' : '' }}">
    ...
    <div class="col-md-9 form-control-static">
        {!! Form::textarea('organization', isset($row->organization) ? $row->organization : null, [$mode === 'add' ? 'autofocus' : null, 'class' => 'form-control', 'id' => 'organization', 'maxlength' => '255', 'placeholder' => '', 'rows' => '1']) !!}
...
<div class="form-group{{ $errors->has('department') ? ' has-error' : '' }}">
    ...
    <div class="col-md-9 form-control-static">
        {!! Form::text('department', isset($row->department) ? $row->department : null, [$mode === 'add' ? 'autofocus' : null, 'class' => 'form-control', 'id' => 'department', 'maxlength' => '255', 'placeholder' => '']) !!}
...
<div class="form-group{{ $errors->has('position') ? ' has-error' : '' }}">
    ...
    <div class="col-md-9 form-control-static">
        {!! Form::text('position', isset($row->position) ? $row->position : null, [$mode === 'add' ? 'autofocus' : null, 'class' => 'form-control', 'id' => 'position', 'maxlength' => '255', 'placeholder' => '']) !!}
...
<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
    <label for="email" class="col-md-2 control-label">メールアドレス<span class="attention">*</span></label>
...
<div class="form-group{{ $errors->has('postcode') ? ' has-error' : '' }}">
    ...
    <div class="col-md-3 form-control-static">
        {!! Form::tel('postcode', isset($row->postcode) ? $row->postcode : null, [$mode === 'add' ? 'autofocus' : null, 'class' => 'form-control', 'id' => 'postcode', 'maxlength' => '7', 'placeholder' => 'ハイフンは省略']) !!}
...
<div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
    ...
    <div class="col-md-9 form-control-static">
        {!! Form::textarea('address', isset($row->address) ? $row->address : null, [$mode === 'add' ? 'autofocus' : null, 'class' => 'form-control', 'id' => 'address', 'maxlength' => '255', 'placeholder' => '', 'rows' => '2']) !!}
...
<div class="form-group{{ $errors->has('tel') ? ' has-error' : '' }}">
    ...
    <div class="col-md-4 form-control-static">
        {!! Form::tel('tel', isset($row->tel) ? $row->tel : null, [$mode === 'add' ? 'autofocus' : null, 'class' => 'form-control', 'id' => 'tel', 'maxlength' => '15', 'placeholder' => 'ハイフンは省略']) !!}
...
<div class="form-group{{ $errors->has('fax') ? ' has-error' : '' }}">
    ...
    <div class="col-md-4 form-control-static">
        {!! Form::tel('fax', isset($row->fax) ? $row->fax : null, [$mode === 'add' ? 'autofocus' : null, 'class' => 'form-control', 'id' => 'fax', 'maxlength' => '15', 'placeholder' => 'ハイフンは省略']) !!}
