...
<div class="form-group{{ $errors->has('subject') ? ' has-error' : '' }}">
    <label for="subject" class="col-md-3 control-label">題名</label>
...
<div class="form-group{{ $errors->has('from') ? ' has-error' : '' }}">
    <label for="from" class="col-md-3 control-label">差出人</label>
...
<div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
    <label for="content" class="col-md-3 control-label">本文</label>
